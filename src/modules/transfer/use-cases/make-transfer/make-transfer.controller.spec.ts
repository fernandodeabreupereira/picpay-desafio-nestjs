...
import { insufficientBalanceExceptionMessage } from '../../../../exceptions/transfer/insufficient-balance.exception';
import { invalidEmailTransferExceptionMessage } from '../../../../exceptions/transfer/invalid-email-transfer.exception';
import { transferErrorExceptionMessage } from '../../../../exceptions/transfer/transfer-error.exception';
import { transferToOwnEmailExceptionMessage } from '../../../../exceptions/transfer/transfer-to-own-email.exception';
import { unauthorizedRoleTransferExceptionMessage } from '../../../../exceptions/transfer/unauthorized-role-transfer.exception';
...
describe('MakeTransferController', () => {
  ...
  it('should NOT make a transfer if the request body data is invalid', async () => {
    ...
    const expectedMessage = [
      ...
      'value must contain a maximum of two decimal places.',
